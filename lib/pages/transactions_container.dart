            ...
            children: [
              Row(
                children: [
                  ...
                  Spacer(),
                  Text("Rs. 7 500", style: TextStyle(color: MyThemes.inflowColor),)
                ],
              ),
              SizedBox(height: 10,),
              Row(
                children: [
                  ...
                  Spacer(),
                  Text("Rs. 4 000", style: TextStyle(color: MyThemes.outflowColor))
                ],
              ),
              Container(
  ...
  return Container(
    ...
    child: Column(
      children: [
        Row(
          children: [
            Icon(Icons.fastfood_outlined, size: 30, color: Colors.brown,),
            SizedBox(width: 12,),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Food & Beverages"),
                Text("Roots, Banana Boat", style: TextStyle(
